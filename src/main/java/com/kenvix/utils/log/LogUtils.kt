...
fun Logger.trace(extraMessage: String = "") = this.log(Level.FINER, extraMessage)

fun Logger.finer(throwable: Throwable, extraMessage: String = "") = this.log(Level.FINER, extraMessage, throwable)
fun Logger.debug(extraMessage: String = "") = this.log(Level.FINE, extraMessage)
...
fun Logger.warn(extraMessage: String = "") = this.log(Level.WARNING, extraMessage)
